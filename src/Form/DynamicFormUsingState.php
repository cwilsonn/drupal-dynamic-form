 ...
 */
class DynamicFormUsingState extends FormBase
{
  /**
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['description'] = [
      '#markup' => $this->t('This form uses the #states property to dynamically show and hide a conditional field. See <a href="/dynamic-form/form-demo">this page</a> for an example using an AJAX callback function per project requirements.'),
    ];
    ...
    $form['other'] = [
      ...
      '#attributes' => [
        'id' => 'field-framework-other'
      ],
      '#states' => [
        'visible' => [
          ':input[id="field-framework-select"]' => ['value' => 'other'],
        ],
      ],
    ];
  ...
  {
    return 'dynamic_form_dynamic_form_using_state';
  }
